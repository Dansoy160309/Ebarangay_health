...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mb-10">
        <h1 class="text-4xl font-black text-gray-900 tracking-tight mb-2">Register Medicine</h1>
        <p class="text-gray-500 font-medium">Add a new medicine to the inventory and configure its base properties.</p>
    </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-gray-200/40 border border-gray-100 p-8 md:p-12 overflow-hidden relative">
        ...
        @if($errors->any())
            <div class="mb-10 rounded-3xl border border-red-100 bg-red-50/50 p-6 text-sm text-red-800 animate-in fade-in slide-in-from-top-4 duration-300">
        ...
        <form method="POST" action="{{ route('admin.medicines.store') }}" class="space-y-12 relative z-10">
            @csrf
            ...
            <div class="space-y-8 pt-4">
                <div class="flex items-center gap-3">
                    <div class="h-10 w-10 rounded-2xl bg-gray-50 text-gray-600 flex items-center justify-center">
                        <i class="bi bi-box-seam text-xl"></i>
                    </div>
                    <h2 class="text-xl font-black text-gray-900">Inventory Settings</h2>
                </div>
