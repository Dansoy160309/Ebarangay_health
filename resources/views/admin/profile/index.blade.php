...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-[2rem] shadow-xl overflow-hidden">
        {{-- Cover Image --}}
        <div class="h-32 sm:h-48 bg-gradient-to-r from-gray-800 to-gray-600 relative">
        ...
        <div class="relative px-6 sm:px-10 pb-6">
            <div class="flex flex-col sm:flex-row items-center sm:items-end -mt-12 sm:-mt-16 mb-6 gap-6">
                {{-- Avatar --}}
                <div class="relative">
                    <div class="h-24 w-24 sm:h-32 sm:w-32 rounded-full ring-4 ring-white bg-white flex items-center justify-center text-3xl sm:text-4xl font-bold text-gray-700 shadow-md">
                ...
                <div class="text-center sm:text-left flex-1">
                    ...
                    <div class="flex items-center justify-center sm:justify-start gap-2 mt-2 text-gray-600">
                        <span class="px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wide bg-blue-50 text-blue-600 border border-blue-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4 p-3 hover:bg-gray-50 rounded-[1rem] transition border border-transparent hover:border-gray-100">
                ...
                <div>
                    ...
                    {{-- Security Notice --}}
                    <div class="mt-6 flex items-start gap-3 p-4 bg-yellow-50 text-yellow-800 rounded-[1rem] text-sm border border-yellow-100">
