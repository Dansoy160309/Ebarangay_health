    ...
    <div class="bg-gradient-to-r from-brand-600 to-brand-500 rounded-[2rem] shadow-lg p-8 text-white relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                ...
                <p class="text-brand-100 mt-2 text-lg">Update the details for <span class="font-bold text-white">{{ $service->name }}</span>.</p>
            </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="relative">
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Briefly describe what this service entails...">{{ old('description', $service->description) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <label class="relative flex flex-col items-center p-4 border rounded-xl cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-all group">
                            <input type="radio" name="provider_type" value="Doctor" class="peer sr-only" {{ old('provider_type', $service->provider_type) == 'Doctor' ? 'checked' : '' }} required>
                        ...
                        <label class="relative flex flex-col items-center p-4 border rounded-xl cursor-pointer hover:bg-pink-50 hover:border-pink-200 transition-all group">
                            <input type="radio" name="provider_type" value="Midwife" class="peer sr-only" {{ old('provider_type', $service->provider_type) == 'Midwife' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex flex-col items-center p-4 border rounded-xl cursor-pointer hover:bg-purple-50 hover:border-purple-200 transition-all group">
                            <input type="radio" name="provider_type" value="Both" class="peer sr-only" {{ old('provider_type', $service->provider_type) == 'Both' ? 'checked' : '' }}>
