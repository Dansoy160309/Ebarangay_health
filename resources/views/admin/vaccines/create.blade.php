...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-10 flex items-center gap-6">
        ...
        <div>
            <h1 class="text-3xl font-black text-gray-900 tracking-tight">Register Vaccine</h1>
            <p class="text-sm font-bold text-gray-500 uppercase tracking-widest mt-1">Add a new vaccine type to the center</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden relative">
        ...
        <form action="{{ route('admin.vaccines.store') }}" method="POST" class="p-10 relative z-10 space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3" placeholder="Additional details about the vaccine..."
                              class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-base font-black text-gray-900 focus:ring-4 focus:ring-brand-500/10 transition-all placeholder:text-gray-300">{{ old('description') }}</textarea>
                </div>
            </div>
