    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-gray-900 rounded-[3rem] p-8 text-white shadow-xl relative overflow-hidden group">
                ...
                <a href="{{ route($prefix . '.dashboard') }}" class="block w-full py-4 bg-white/10 hover:bg-white/20 border border-white/10 rounded-2xl text-center text-xs font-black uppercase tracking-[0.2em] transition-all">
                    Contact Center
                </a>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        @foreach($recent as $item)
                            <a href="{{ route($prefix . '.announcements.show', $item->id) }}" class="block p-6 bg-white border border-gray-100 rounded-[2rem] shadow-sm hover:shadow-lg hover:border-brand-200 transition-all group">
