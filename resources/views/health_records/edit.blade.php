...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        <a href="{{ url()->previous() }}" class="bg-white p-2 rounded-lg shadow-sm text-gray-500 hover:text-brand-600 transition">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-full">
                    ...
                    <div>
                        ...
                        <textarea name="consultation" id="consultation" rows="12" class="w-full border-gray-200 rounded-lg shadow-sm focus:border-brand-500 focus:ring-brand-500 leading-relaxed" placeholder="Enter chief complaint, history of present illness, diagnosis, and treatment plan...">{{ old('consultation', $record->consultation) }}</textarea>
                        @error('consultation')
                            <p class="text-red-500 text-xs mt-1 flex items-center gap-1">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </p>
