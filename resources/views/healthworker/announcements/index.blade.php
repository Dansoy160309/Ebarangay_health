        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-[10px] font-black uppercase tracking-[0.2em]">
                <li class="inline-flex items-center">
                    <a href="{{ route('healthworker.dashboard') }}" class="text-gray-400 hover:text-brand-600 transition-colors flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($announcements as $announcement)
                <div x-show="search === '' || 
                     ...
                     class="h-full">
                    <a href="{{ route('healthworker.announcements.show', $announcement->id) }}" 
    ...
    @else
        <div class="text-center py-40 bg-white rounded-[5rem] border-2 border-dashed border-gray-100 shadow-sm overflow-hidden relative">
            ...
            <div class="relative z-10 max-w-md mx-auto px-6">
                ...
                <a href="{{ route('healthworker.dashboard') }}" class="inline-flex items-center gap-3 px-10 py-4 bg-gray-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-brand-600 transition-all shadow-xl shadow-gray-200">
