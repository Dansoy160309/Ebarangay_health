                    ...
                    <tr class="hover:bg-gray-50/80 transition-all duration-300 group/row">
                        <td class="px-10 py-8">
                            <div class="flex items-center gap-5">
                                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-gray-500 font-black text-lg shadow-inner group-hover/row:scale-110 transition-transform duration-500">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-1.5">
                                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest bg-gray-100 px-2 py-0.5 rounded-md">{{ $appt->user->age ?? 'N/A' }} Yrs</span>
                                        <span class="w-1 h-1 rounded-full bg-gray-300"></span>
                                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest">{{ $appt->user->gender }}</span>
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-10 py-8">
                            <div class="space-y-1.5">
                                <div class="flex items-center gap-2">
                                    <i class="bi bi-calendar-x text-red-500 text-sm"></i>
                                ...
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-6">
                        ...
                        <td class="px-10 py-8">
                            ...
                            <div class="flex flex-col gap-2">
                                @if($contactNo)
                                <a href="tel:{{ $contactNo }}" class="inline-flex items-center gap-2.5 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all border border-emerald-100 w-fit">
                                    <i class="bi bi-telephone-fill"></i>
                                    {{ $contactNo }}
                                </a>
                                @else
                                <span class="text-[10px] font-black text-gray-300 uppercase tracking-widest italic">No Contact Provided</span>
                                @endif
                                
                                @if($isDependent)
                                    <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
