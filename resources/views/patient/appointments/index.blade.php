...
<div class="py-6 space-y-8" x-data="{ 
    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg md:hidden">
        <div class="max-w-lg mx-auto grid grid-cols-5 gap-1 px-2 py-1 text-xs font-black text-gray-600">
            <a href="{{ route('patient.dashboard') }}" class="flex flex-col items-center justify-center py-2 text-gray-600 hover:text-brand-600 focus:outline-none focus:ring-0 active:outline-none">
