                        ...
                        @forelse($appointments as $appointment)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-8 py-6 text-right">
                                    ...
                                    @else
                                        <div class="w-6 h-6 rounded-full bg-gray-50 flex items-center justify-center text-gray-300 border border-gray-100">
            ...
            <div class="md:hidden divide-y divide-gray-50">
                @forelse($appointments as $appointment)
                    <div class="p-6 space-y-4">
                        ...
                        @else
                            <div class="w-full py-3 flex items-center justify-center bg-gray-50 rounded-xl border border-gray-100 text-gray-400 text-[10px] font-black uppercase tracking-widest">
                                <i class="bi bi-lock-fill mr-2"></i> Cannot Cancel
                            </div>
                        @endif
                    </div>
                @empty
